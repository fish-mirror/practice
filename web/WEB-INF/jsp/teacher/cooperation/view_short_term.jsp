                                        ...
                                        <div class="col-sm-12">
                                            <h4>项目名称:<s:property value="shortTerm.name"/>
                                                <s:if test="shortTerm.fileUrl!=null && shortTerm.fileUrl!=''">
                                                    <a style="float:right"
                                                       href="<s:property value="shortTerm.fileUrl" />">下载附件</a>
                                                </s:if>
                                            </h4>
                                            <hr/>
                                            ...
                                            <p></p>
                                            <h2>专业要求</h2>
                                            <p><s:property value="shortTerm.majorNeed"/></p>
                                            <p></p>
                                            <h2>项目目标</h2>
                                            <p><s:property value="shortTerm.purpose"/></p>
                                            <p></p>
                                            <h2>内容安排</h2>
                                            <p><s:property value="shortTerm.content"/></p>
                                            <p></p>
                                            <h2>时间安排</h2>
                                            <p><s:property value="shortTerm.time"/></p>
                                            <p></p>
                                            <h2>实践地点</h2>
                                            <p><s:property value="shortTerm.plasce"/></p>
                                        </div>
                                    </div>
                                </div>
                            </div>
