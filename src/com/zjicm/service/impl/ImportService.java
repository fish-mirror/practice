...
public class ImportService implements IImportService{
	...
	ShortTermProjectDao shortTermProjectDao;
	ShortTermReportDao shortTermReportDao;
	ShortTermService sts;
	...
	public ShortTermProjectDao getShortTermProjectDao() {
		return shortTermProjectDao;
	}
	@Resource
	public void setShortTermProjectDao(ShortTermProjectDao shortTermProjectDao) {
		this.shortTermProjectDao = shortTermProjectDao;
	}
	
	public ShortTermReportDao getShortTermReportDao() {
		return shortTermReportDao;
	}
	@Resource
	public void setShortTermReportDao(ShortTermReportDao shortTermReportDao) {
		this.shortTermReportDao = shortTermReportDao;
	}
	
	public ShortTermService getSts() {
		return sts;
	}
	@Resource
	public void setSts(ShortTermService sts) {
		this.sts = sts;
	}
	/*
	 * 获取excel文件数据，插入数据库
    		...
    		for(int i = 0;i<length;i++){
    	        ...
    	        for(int rowNum = 2; rowNum < totalRow; rowNum++){
                    ...
                    if(stuId ==null||stuId.equals("")){
            			...
            			String result = sts.addSelectProject(stp.getId(), stuId, major, institute, null);
